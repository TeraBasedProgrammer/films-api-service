...
from .validators import validate_imdb_id, validate_rating
...
class FilmSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        session = requests_cache.CachedSession(cache_name=f'{os.path.dirname(__file__)}/cache/imdb-cache', backend='sqlite', expire_after=None)
